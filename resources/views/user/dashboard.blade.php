...
<body>
                ...
                <div class="col-12">
                    <nav class="main-nav">
                        ...
                        <ul class="nav">
                            ...
                            <li class="main-button"><a href="#">Masuk</a></li>
                        </ul>        
    ...
    <div class="main-banner" id="top">
        ...
        <div class="video-overlay header-text">
            <div class="caption">
                <h6>Kekuatan, Kebugaran, Ketahanan</h6>
                <h2>Semuanya Ada <em>Disini</em></h2>
            ...
            <div class="row">
                <div class="col-lg-10 offset-lg-1">
                    <div class="cta-content">
                        <h2>Jangan <em>Berpikir</em>, Mulailah <em>Hari ini</em>!</h2>
